...
- **No authentication.** Workflows are not persisted between sessions. Refreshing the page clears the canvas.
...
- **Single-user.** There is no multi-tenancy, workspace isolation, or concurrent editing support.
...
_Built with React 19 · TypeScript · @xyflow/react · Zustand · MSW · Tailwind CSS_

...
![HR Workflow Designer Architecture](public/architecture%20diagram.png)
...
![Sample Workflow Designer UI](public/sample_screenshot.png)
...
src/
	...
	components/
		canvas/          # Canvas, toolbar, palette
		forms/           # Node configuration forms
		nodes/           # Custom React Flow node renderers
		simulation/      # Simulation viewer
		ui/              # Shared UI controls
	hooks/             # useSimulation, useAutomations
	mocks/             # MSW browser and handlers
	store/             # Zustand workflow store
	types/             # Domain and contract types
	utils/             # Validator and node defaults
```
...
```json
{
	...
	"edges": [
		...
		{ "id": "e-task-end", "source": "task-1", "target": "end-1" }
	]
}
```
